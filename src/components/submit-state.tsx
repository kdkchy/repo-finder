...
export default function SubmitState(props: {
    value: ESubmitState
}){
    return (
        <div className="flex justify-center mt-10">
            ...
            {props.value == ESubmitState.ERROR && (
                <>
                    ...
                    <div className="text-xl italic">Something went wrong, but dont worries our man is figuring out how to fix this issue</div>
                </>
            )}
        </div>
    )
